...
class ForSale(scrapy.Spider):
    ...
    base_url = 'https://www.trademe.co.nz/a/property/retirement-villages/'
    ...
    def start_requests(self):
        url = self.base_url + self.location + '/' + self.district
    ...
    def parse_listing(self, response):
        ...
        yield {
            ...
            'car_spaces' : response.xpath("/html/body/trade-me/div[1]/main/div/tm-property-listing/div/tm-property-listing-body/div/section[1]/tg-row/tg-col/tm-property-listing-attributes/section/table/tbody/tr[4]/td[2]/text()").get(),
