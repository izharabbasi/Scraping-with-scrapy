...
class Agents(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for postcode in self.postcodes:
            ...
            yield scrapy.Request(url=next_postcode, headers=self.headers, callback=self.parse_links)
            break
    ...
    def parse_links(self,res):
        ...
        for card in cards:
            ...
            yield scrapy.Request(url=links, headers=self.headers, callback=self.parse_agents)
